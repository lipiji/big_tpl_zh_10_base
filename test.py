...
from data import Vocab, DataLoader, s2t, s2xy, s2xy_4paper
...
ds = []
with open("./model/test.txt", "r") as f:
    for line in f:
        line = line.strip()
        if line:
            ds.append(line)
...
for i in range(5):
    ...
    while idx < len(ds):
        ...
        ys_truth, ys_inp, ys_tpl, ys_seg, ys_pos, msk = s2xy_4paper(cplb, lm_vocab, lm_args.max_len, 2)
